                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="cat_add.php" class="dropdown-item">Add Category</a>
                            <!-- <a href="cat_update.php" class="dropdown-item">Edit Category</a> -->
                            <a href="cat_view.php" class="dropdown-item">View Category </a>
                        </div>
                    </div>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="pro_add.php" class="dropdown-item">Add Products</a>
                            <!-- <a href="cat_update.php" class="dropdown-item">Edit Category</a> -->
                            <a href="pro_view.php" class="dropdown-item">View Products </a>
                        </div>
                    </div>
